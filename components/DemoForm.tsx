  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 h-full">
      <div className="flex flex-col gap-y-4 mx-auto">
        ...
        />
        <h1 className="text-black text-2xl font-semibold">Hindustani Tongue</h1>
        <Badge variant="outline" className="w-[10rem] flex items-center justify-center space-x-2 py-2">
          <Clock className="w-4 h-4" />
          <span>30 Minutes</span>
        </Badge>
        <p className="text-xl">Choose a time that works for you.</p>
      </div>
